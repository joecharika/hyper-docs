...
class HyperException extends Exception
{
    ...
    private function run()
    {
        ...
        $stackTrace = $config->debug
            ? "<div class=\"h-exc-stacktrace\">
                <h5><i>Stacktrace</i></h5>
                <p># $type</p>
                <pre class=\"h-exc-code\">$stackTrace</pre>
                <br>
            </div>"
            : '';
        ...
        try {
            echo $twig->render($file, [
                ...
                'website' => Arr::key($_SERVER, "HTTP_HOST", 'unknown_site') . Arr::key($_SERVER, 'PATH_INFO',
                        ''),
